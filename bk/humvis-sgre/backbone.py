...
HRNET32 = CN()
HRNET32.STAGES = CN()
HRNET32.STAGES.NUM_STAGES = 3
HRNET32.STAGES.NUM_MODULES = [1, 4, 3]
HRNET32.STAGES.NUM_BRANCHES = [2, 3, 4]
HRNET32.STAGES.BLOCK = ['BASIC', 'BASIC', 'BASIC']
HRNET32.STAGES.NUM_BLOCKS = [[4, 4], [4, 4, 4], [4, 4, 4, 4]]
HRNET32.STAGES.NUM_CHANNELS = [[32, 64], [32, 64, 128], [32, 64, 128, 256]]
HRNET32.STAGES.FUSE_METHOD = ['SUM', 'SUM', 'SUM']
